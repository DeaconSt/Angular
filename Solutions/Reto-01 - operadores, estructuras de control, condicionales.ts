...
// OR ||
let orResult1: boolean = true || true; //truue
...
let message1 = "Hola mundo verdadero";
console.log(message1.includes("Hola")); //true
console.log(message1.includes("falso")); //false
console.log(message1.includes("x")); //false
console.log(message1.includes("e")); //true
